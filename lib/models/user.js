...
var mongooseHRBAC = require('mongoose-hrbac');
var jsonSchemaPlugin = require('mongoose-json-schema');
...
function getPrivateJSON(rbac, cb) {
 ...
 */
function generateAccessToken(tokenSecret, expiresInMinutes, scope) {
	if(!tokenSecret) {
...
function findByPermalink(permalink, cb) {
...
module.exports = function (server) {
	return server.db.model('User', createSchema(server.db.base.Schema));   
};
